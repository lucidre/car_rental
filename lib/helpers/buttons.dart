...
Widget _buildIcon(BuildContext context, IconData icon,
    ...
    Icon(icon,
        color: color ?? ((isOutlined) ? neutral800 : shadeWhite),
        size: size ?? 18);
...
class AppBtn extends StatelessWidget {
          ...
          child: CircularProgressIndicator.adaptive(
            valueColor: Platform.isIOS
                ...
                : AlwaysStoppedAnimation<Color>(
                    isOutlined ? neutral700 : shadeWhite),
            backgroundColor:
                Platform.isIOS ? (isOutlined ? neutral700 : shadeWhite) : null,
          ),
        );
  ...
  Widget build(BuildContext context) {
    Color defaultColor = borderColor ?? neutral300;
    Color textColor =
        (isOutlined ? !isSecondary : isSecondary) ? Colors.black : shadeWhite;
    ...
    return Container(
      decoration: BoxDecoration(
        color: isSecondary ? Colors.black : shadeWhite,
